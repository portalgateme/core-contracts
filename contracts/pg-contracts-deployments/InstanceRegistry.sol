...
contract InstanceRegistry is Initializable, EnsResolve {
    ...
    constructor(Tornado[] memory _instances, bytes32 _router) public {
     ...
     * */
    function setTornadoRouter(address routerAddress) external {
    ...
    function _updateInstance(Tornado memory _tornado) internal virtual {
        ...
        if (_tornado.instance.isERC20 == true) {
            ...
            require(address(router) == 0x3Cda73C4fE96C4369786728Ed54f056F9E45565B, "Incorrect router");
            require(allowance == 0, "Incorrect allowance");
