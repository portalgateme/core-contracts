...
contract TornadoRouter is EnsResolve {
    ...
    function updateInstanceRegistry(address _instanceRegistry) external {
        instanceRegistry = InstanceRegistry(_instanceRegistry);
    }

    function updateRelayerRegistry(address _relayerRegitry) external {
        relayerRegistry = RelayerRegistry(_relayerRegitry);
    }
